...
function infoButtonListener() {
    ...
    var keuzeb = document.getElementsByName("serviceKapper");
    var over = document.getElementsByName("keuzebehandelingoverig");
    var fin = document.getElementsByName("servicescategorie");
        ...
        .then(response => {
            ...
            response.json().then(beschikbaarTijdlist => {
                ...
                for (let i = 0; i < beschikbaarTijdlist.length; i++) {
                    ...
                    // {/* <input type="radio" id="afspraaktijd" name="afspraaktijd" value="8:30-9:00"  onclick="myFunction()"> */}
                    tijdblok.type = "radio";
                    tijdblok.id = "afspraaktijd-" + i;
                    tijdblok.name = "afspraaktijd";
                    tijdblok.value = Tijd;
...
function myFunction() {
    ...
    var tijd = document.getElementsByName("afspraaktijd");
